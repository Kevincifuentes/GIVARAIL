...
with open('valoresPrueba_250117_071426219163_formatLatLng.csv', 'wb') as csvfile:
    ...
    with open('valoresPrueba_250117_071426219163_format.csv', 'rb') as csvfile:
     ...
     for row in spamreader:
         ...
         spamwriter.writerow([latitud, longitud, altitud, aceleracionX, aceleracionY, aceleracionZ, giroscopioX, giroscopioY, giroscopioZ, magnetometroX, magnetometroY, magnetometroZ, yaw, pitch, roll, barometro, hdop, vdop, pdop, timeStamp])
