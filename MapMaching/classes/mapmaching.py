...
def puntoACurvaArea(listaPlanimetria, segmentos, listaMedidas):
    """
    ...
    for i in xrange(len(listaMedidas)):
        ...
        for segmento in segmentos:
            if dentroDeArea(segmento.nodoA, nodo, 0.1) == True or dentroDeArea(segmento.nodoB, nodo, 0.1) == True:
...
def curvaACurvaArea(listaPlanimetria, segmentos, listaMedidas):
    """
    Funcion que calcula la traza mejorada utilizando la tecnica curva a curva
    """
    num_min_candidatos = 2
